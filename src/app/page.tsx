                  ...
                  <div key={item.id} className="group relative flex flex-col md:grid md:grid-cols-[40px_4fr_1.5fr_2.5fr_2.5fr_40px] gap-3 md:gap-4 items-start md:items-center p-4 md:p-3 bg-white border border-slate-200/60 hover:border-brand/30 hover:shadow-md rounded-2xl transition-all duration-200">
                    ...
                    <div className="w-full grid grid-cols-[1fr_2.5fr] gap-3 md:contents">
                      ...
                      <div className="w-full min-w-0">
                        ...
                        <input className="w-full px-2 py-2.5 bg-slate-50 border border-slate-200/80 rounded-xl text-slate-800 text-base font-bold text-center focus:outline-none focus:bg-white focus:border-brand focus:ring-4 focus:ring-brand/10 transition-all" type="number" min={1} max={99999} placeholder="1" value={item.qty || ""} onChange={e => updateItem(item.id, "qty", e.target.value)} />
                      </div>
